...
export default {
  ...
  data() {
    return {
      ...
      fechaEmision: '01 ENE 2022',
      fechaVencimiento: '01 ENE 2028',
  ...
  <div class="carnet">
    <aside>
      <div>
        ...
        <img width="40" src="../assets/img/chile_bandera.png" alt="bandera chilena" />
      </div>

      <img src="../assets/img/foto_elon.jpg" alt="elon musk" />
      <p>RUN {{ run }}</p>
    </aside>
